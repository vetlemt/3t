...
pub fn build(b: *std.Build) void {
    ...
    // Add C sources and include path
    //exe.addIncludePath(b.path("src-c"));
    //exe.addCSourceFile(.{
    //    .file = b.path("src-c/linux/device_events.c"),
    //    .flags = &[_][]const u8{"-std=c11"}, // Or c11 if needed
    //});
    //exe.linkLibC(); // Link libc for open/read/etc.
